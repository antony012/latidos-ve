...
export function MapActionBar() {
  ...
  return (
    <>
      <div className="shrink-0 border-b bg-background px-3 py-2 sm:py-3">
        ...
        <p className="mt-1.5 hidden text-center text-[11px] text-muted-foreground sm:block sm:text-xs">
